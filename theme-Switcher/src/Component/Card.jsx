...
export default function Card() {
    ...
    return (
        <div className="w-full bg-white border border-gray-200 rounded-lg shadow">
            <a href="/">
                {thememode === "dark" ?
                    <img className="p-8 rounded-t-lg" src="https://images.pexels.com/photos/1716158/pexels-photo-1716158.jpeg?auto=compress&cs=tinysrgb&w=600" alt="product_image1" /> :
                    <img className="p-8 rounded-t-lg" src="https://images.pexels.com/photos/189349/pexels-photo-189349.jpeg?auto=compress&cs=tinysrgb&w=600" />
                }
